...
!(function () {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((e, t, n) => {
              ...
              return (
                (o = e),
                !!t.prototype.isPrototypeOf(o) ||
                  (null === (r = e.constructor) || void 0 === r ? void 0 : r.name) === t.name
              )
            })(e, String)
          ? 'string'
          : t
  ...
  const w = Array.prototype.slice,
    ...
    _ = (e, t) =>
      ((e, t, n) => {
        for (let r = 0, o = e.length; r < o; r++) {
          const o = e[r]
          if (t(o, r)) return k.some(o)
          if (n(o, r)) break
        }
        return k.none()
      })(e, t, b),
    D = (e, t) => {
      for (let n = 0, r = e.length; n < r; n++) if (t(e[n], n)) return k.some(n)
      return k.none()
    },
    P = (e) => {
      const t = []
  ...
  const q = (e) => parseInt(e, 10),
    ...
    J = (e, t, n) => ({ major: e, minor: t, patch: n }),
    Y = (e) => {
    ...
    me = (e) => {
      var t
      return tinymce.explode(
        null !== (t = e.options.get('images_file_types')) && void 0 !== t ? t : ''
      )
    },
    pe = (e) => {
      let t = e
    ...
    ye = (e, t) => ((void 0 !== e[t] && null !== e[t]) || (e[t] = {}), e[t]),
    be = (e, t) =>
      ((e, t) => {
        let n = void 0 !== t ? t : ve
    ...
    Je = [
      ...
      { name: 'ChromeOS', search: qe('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] }
    ],
    Ye = { browsers: m(Ke), oses: m(Je) },
    Xe = 'Edge',
    Ze = 'Chromium',
    Qe = 'Opera',
    et = 'Firefox',
    ...
    rt = () => nt({ current: void 0, version: $e.unknown() }),
    ot = nt,
    st = (m(Xe), m(Ze), m('IE'), m(Qe), m(et), m(tt), 'Windows'),
    at = 'Android',
    it = 'Linux',
    lt = 'macOS',
    ct = 'Solaris',
    ...
    mt = () => ht({ current: void 0, version: $e.unknown() }),
    pt = ht,
    ft =
      (m(st),
      m('iOS'),
          ...
          .bind((e) =>
            ((e, t) =>
              U(t.brands, (t) => {
                ...
                }).map((e) => ({ current: e.name, version: $e.nu(parseInt(t.version, 10), 0) }))
              }))(r, e)
          )
          .orThunk(() =>
            ((e, t) =>
  ...
  const vt = () => gt(),
    ...
    xt = m({ isSupported: !1, cleanDocument: () => Promise.reject('not supported') })
  var kt = bt
    ? xt
    : (e, t, n) => {
        const r =
        ...
        return (
          ...
          }),
          {
            isSupported: !0,
            cleanDocument: (e, t, n) =>
              o.then((r) => r.cleanDocument(e, t, n.cleanFilteredInlineElements))
          }
        )
      }
  const wt = (e) => {
    ...
    St = (e) => {
      const t = Me(e, (e) => ({ bind: e.bind, unbind: e.unbind })),
        n = Me(e, (e) => e.trigger)
    ...
    Tt = (e, t) => {
      ...
      return (1 !== (r = n).nodeType && 9 !== r.nodeType && 11 !== r.nodeType) ||
        ...
        ? []
        : A(n.querySelectorAll(e), _e.fromDom)
      var r
    },
    It = (e, t) => e.dom === t.dom,
    At = Ct,
    ...
    Et = (e, t, n, r, o) => {
      ...
      return s.setStart(t.dom, n), s.setEnd(r.dom, o), s
    },
    Lt = (e) => {
      ...
      return (
        O(e, (r, s) => {
          ...
          if (!o(l)) throw new Error('case arguments must be an array')
          t.push(i),
            (n[i] = (...n) => {
              const r = n.length
              if (r !== l.length)
              ...
              return {
                ...
                log: (e) => {
                  console.log(e, { constructors: t, constructor: i, params: n })
                }
              }
            })
        }),
    ...
    _t = (e, t, n) =>
      t(_e.fromDom(n.startContainer), n.startOffset, _e.fromDom(n.endContainer), n.endOffset)
  Nt.ltr, Nt.rtl
  const Dt = (e, t, n, r) => ({ start: e, soffset: t, finish: n, foffset: r }),
    ...
    Gt = (e) => {
      ...
      return ((e) => {
        ...
        var n
      })(_e.fromDom(t)).fold(() => n.body.contains(t), ((r = Gt), (o = Vt), (e) => r(o(e))))
      var r, o
    },
    qt = (e, t) => {
      let n = []
      return (
        O(zt(e), (e) => {
          t(e) && (n = n.concat([e])), (n = n.concat(qt(e, t)))
        }),
        n
      )
    },
    Kt = (e, t) => Tt(t, e),
    Jt = Lt([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
    Yt = {
      before: Jt.before,
      on: Jt.on,
      after: Jt.after,
          ...
          return ((e, t) => {
            ...
            return n.collapsed
              ? t
                  ...
                  .map((e) =>
                    Nt.rtl(
                      _e.fromDom(e.endContainer),
                      e.endOffset,
                      _e.fromDom(e.startContainer),
                      e.startOffset
                    )
                  )
                  .getOrThunk(() => _t(0, Nt.ltr, n))
              : _t(0, Nt.ltr, n)
          })(0, n)
        })(e, t).match({
          ltr: (t, n, r, o) => {
          ...
          rtl: (t, n, r, o) => {
            tn(e).each((s) => {
              if (s.setBaseAndExtent) s.setBaseAndExtent(t.dom, n, r.dom, o)
                ...
                try {
                  ;((e, t, n, r, o, s) => {
                    t.collapse(n.dom, r), t.extend(o.dom, s)
                  })(0, s, t, n, r, o)
                } catch (s) {
                  nn(e, r, o, t, n)
                }
    ...
    on = (e) => {
      if (e.rangeCount > 0) {
        ...
        return k.some(
          Dt(_e.fromDom(t.startContainer), t.startOffset, _e.fromDom(n.endContainer), n.endOffset)
        )
      }
      return k.none()
    },
    sn = (e) => {
      if (null === e.anchorNode || null === e.focusNode) return on(e)
      {
        ...
        })(t, e.anchorOffset, n, e.focusOffset)
          ? k.some(Dt(t, e.anchorOffset, n, e.focusOffset))
          : on(e)
      }
    },
    an = (e) =>
  ...
  const xn = (e) => {
    ...
    Vn = (e, t) => {
      const n = e.dom
      Fn(n, t), Pn(Tn(e, 'style').map(V), '') && An(e, 'style')
    },
    Gn = (e) => ('rtl' === zn(e, 'direction') ? 'rtl' : 'ltr'),
    qn = (e, t) => {
      const n = (t || document).createElement('div')
      return (n.innerHTML = e), zt(_e.fromDom(n))
    },
    ...
    Qn = (e, t, n) =>
      ((e, t, n, r, o) =>
        ((e, t) => Ct(e, t))(n, r) ? k.some(n) : c(o) && o(n) ? k.none() : t(n, r, o))(
        0,
        Zn,
        e,
        t,
    ...
    ar = or(),
    ir = ar + xn(''),
    lr = ('-100000px', '100000px', (e) => ('rtl' === Gn(e) ? '100000px' : '-100000px'))
  const cr = (e, t) => {
      const n = _e.fromTag('div')
      var r
      Sn(n, t),
        Sn(n, { contenteditable: 'true', 'aria-hidden': 'true' }),
        Bn(n, {
          position: 'fixed',
          top: '0px',
          width: '100px',
      ...
      return {
        ...
        contents: () => (
          ...
          { elements: zt(n), html: Kn(n), offscreen: n }
        ),
        container: m(n),
        detach: () => {
          gn(n)
  ...
  var hr = (e) => (t) => {
    const n = St({ after: wt(['container']) }),
      r = ((e) => {
        ...
        return {
          ...
          toOff: (o, s) => {
            const a = r(s)
            dn(s, t), (n = e.get(a)), e.set(a, yn(t, 0, t, 0))
          }
        }
      })(dr),
      o = ((e, t, n) => {
        const r = cr(e, n),
          o = () => {
            e.cleanup()
            const t = r.contents()
            r.detach(), s.trigger.after(t.elements, t.html, r.container())
          },
          s = St({ before: wt([]), after: wt(['elements', 'html', 'container']) }),
          a = d
        return {
          instance: m(() => {
            s.trigger.before(),
    ...
    return (
      o.events.after.bind((e) => {
        r.toOn(t, e.container), n.trigger.after(e.container)
      }),
      {
        run: () => {
          o.instance()()
  ...
  const mr = er('ephox-cement').resolve,
    pr = {
      ...
      pasteBinAttrs: {},
      keepSrc: !1,
      sanitizer: { sanitizeHtml: m(''), sanitizeText: m('') },
      tabSpaces: 4,
    ...
    wr = () => {
      ...
      return {
        getOrSetIndexed: (t, n) =>
          ((t) => void 0 !== e[t])(t) ? e[t] : ((t, n) => ((e[t] = n), n))(t, n()),
        waitForLoad: () => {
          const t = ((e, t) => {
            const n = []
            return (
    ...
    Tr = { value: Sr, error: Cr, fromOption: (e, t) => e.fold(() => Cr(t), Sr) },
    Ir = (e) => {
      const t = _e.fromDom(
          ((e) => {
            if (Wt() && l(e.target)) {
    ...
    Er = (e, t, n) =>
      ((e, t, n, r) =>
        ((e, t, n, r, o) => {
          ...
          return e.dom.addEventListener(t, s, o), { unbind: g(Ar, e, t, s, o) }
        })(e, t, n, r, !1))(e, t, Or, n),
    Lr = ((e) => {
      const t = g(be, e)
      be('callbacks', t())
      ...
      return { ephemeral: (e) => n(e, !1), permanent: (e) => n(e, !0), unregister: r }
      ...
      vr.nu((n) => {
        const o = (t) => {
            O(a, (e) => {
              ...
              n(
                t.fold(
                  (t) => Tr.error(t + 'Unable to download editor stylesheets from "' + e + '"'),
                  Tr.value
                )
              )
          },
          s = ((e, t) => {
            ...
            return (
              Sn(r, { rel: 'stylesheet', type: 'text/css', href: e }),
              ((e, t) => {
                const n = ((e) => {
                  const t = e.dom.head
          ...
          e.getOrSetIndexed(t, () =>
            ((e) =>
              vr.nu((t) => {
                ...
                const o = Er(r, 'error', () => {
                    n(), t(Tr.error('Error loading external script tag ' + e))
                  }),
                  s = Er(r, 'load', n)
    ...
    Wr = (e) => ({ response: Mr(e), bundle: Hr({}) }),
    $r = (e) => Promise.resolve(Wr(e)),
    Vr = { response: Fr(), bundle: Hr({}) },
    Gr = (e) => l(e.then),
    qr = (e, t, n, r) => ({ steps: e, input: t, label: n, capture: r }),
    Kr = (e, t) => {
      const n = zr(e.bundle, t.bundle),
        r = ((e, t) =>
          Rr(e, k.none, k.none, k.none, (e, n, r) =>
            Rr(t, k.none, (e, t) => k.some(Pr.incomplete(e, t, r)), k.none, k.none)
          ).getOr(t))(e.response, t.response)
      return { response: r, bundle: n }
    },
    Jr = (e, t, n) => {
      const r = () => e,
        o = () => {
    ...
    Yr =
      ...
      (...e) => {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n]
          for (const e in r) Be(r, e) && (t[e] = Xr(t[e], r[e]))
        }
        return t
      })
  var Xr
  const Zr = Lt([
    ...
    eo = (e, t) =>
      e.fold(
        (e, n) => 0 === n(t).indexOf(n(e)),
        (e, n) => e.test(n(t)),
        (e, n) => n(t).indexOf(n(e)) >= 0,
        (e, n) => n(t) === n(e),
        x,
        (e) => !eo(e, t)
      ),
    ...
    ao = (e, t) => {
      ...
      ;((e, t, n) => {
        ...
        const r = Ue(t),
          o = Ue(n)
        if (0 === r && 0 === o) An(e, 'style')
        else if (0 === r) wn(e, 'style', oo(n))
        else {
          Re(t, (t, n) => {
            Un(e, n, t)
          })
    ...
    fo = (e, t, n) => {
        ...
        case 1:
          ...
          o =
            'HTML' !== i.scopeName && i.scopeName && i.tagName && i.tagName.indexOf(':') <= 0
              ? (i.scopeName + ':' + i.tagName).toLowerCase()
      ...
      return { getNode: m(e), tag: () => o, type: () => r, text: () => s }
    },
    go = (e, t, n, r) => {
    ...
    bo = (e) => {
      ...
      return {
        ...
        receive: (o) => {
          switch (o.type()) {
            case uo:
              ;(s = o.getNode().cloneNode(!1)), r(s), (n = s)
              break
            case mo:
              ;((t) => {
    ...
    xo = (e) => (t) => {
      ;((e, t) => {
        const n = Yr({ styles: [], attributes: [], classes: [], tags: [] }, t),
          r = Kt(e, '*')
        O(r, (e) => {
          co(ao, n.styles, e),
    ...
    So = (e) => (t) => {
            ...
            o = ((e, t = window.document) => {
              ...
              return {
                ...
                next: () => {
                  ...
                  return (
                    !s && e.firstChild
                      ? (o.push(e), (r = e.firstChild))
                      : s || 1 !== e.nodeType
                      ? e.nextSibling
                        ? ((r = e.nextSibling), (s = !1))
                        : ((r = o.pop()), (s = !0))
                      : (s = !0),
                    a === yo || r || (t.body.removeChild(n), (r = yo)),
      ...
      fn(t), t.dom.appendChild(r)
    },
    Co = (e, t, n) => {
      const r = _e.fromTag('div', e.dom)
      Bn(r, { position: 'fixed', left: '-100000px', top: '0px' }),
        dn(
          ((e) => {
            const t = e.dom.body
    ...
    To = (e, t) => (n) => {
      const r = (e) => {
        ...
        o = (e, t, n) => ((n = void 0 !== n ? n : e.type() === ho), fo(t, n, {})),
        s = {
          emit: r,
          emitTokens: (e) => {
            O(e, r)
    ...
    Io = (e, t) => {
      if (void 0 === e || void 0 === t) throw (console.trace(), new Error('brick'))
      e.nextFilter.set(t)
    },
    Ao = (e, t, n = !1) =>
      e === t ||
      (l(e) && l(t) && e.tag === t.tag && e.type === t.type && (n || e.variant === t.variant)),
    ...
    Eo = (e, t, n, r) => {
      ...
      return ((a = r.emblems()),
      (i = s),
      _(a, (e) => 'ul' === e.tag || (l(i) && Ao(e, i, !0))).orThunk(() => F(a))).filter(
        (e) =>
          !(
            'ol' === e.tag &&
            ((e) => {
      ...
      const o = r,
        s = ((e) => {
          const t = parseInt(Cn(e, 'data-list-level'), 10),
            ...
            r = l(n) ? JSON.parse(n) : []
          return (
            An(e, 'data-list-level'), An(e, 'data-list-emblems'), { level: m(t), emblems: m(r) }
          )
        })(_e.fromDom(o.getNode()))
      n.originalToken.set(o)
      const a = ((e, t, n) => (
        Eo(n.listType.get(), e, n.emitter, t).each(n.listType.set),
        ((e, t, n) => ({ level: m(e), token: m(t), type: m(n) }))(
          t.level(),
          n.originalToken.get(),
          n.listType.get()
        )
      ))(o, s, n)
      n.emitter.openItem(a.level(), a.token(), a.type()), Io(n, e.inside())
    },
    No = (e, t, n) => ({ pred: e, action: t, label: m(n) })
  var _o = (e, t, n) => {
    const r = (e, r, o) => {
      _(t, (e) => e.pred(r, o)).fold(m(n), (e) => e.action)(e, r, o)
    }
    return (r.toString = () => 'Handlers for ' + e), r
  }
  const Do = (e, t) => ({ state: m(e), result: m(t) }),
    Po = (e, t) => ({ state: m(e), value: m(t) }),
    Ro = (e, t, n, r) => ({ level: m(e), type: m(t), types: m(n), items: m(r) }),
    Mo = (e) => {
    ...
    jo = (e, t, n) => {
      ...
      for (; t(o); ) {
        const e = n(o)
        ;(o = e.state()), (r = r.concat(e.result()))
      }
      return Do(o, r)
    },
    Fo = (e, t, n) => {
      const r = t.start && t.start > 1 ? { start: t.start } : {},
        o = e.level() + 1,
        s = t,
        a = e.types().concat([t]),
        i = [g(go, t.tag, r, n)],
    ...
    Bo = (e, t, n) => {
      const r = (c = t)
          ? ((e) => {
              ...
              return l(t) && '0px' !== t ? { 'margin-left': t } : {}
            })(c)
        ...
        o =
          e.type() && !Ao(e.type(), n)
            ? ((e, t) => {
                const n = Uo(e),
                  r = Fo(n.state(), t, t.type ? { 'list-style-type': t.type } : {})
    ...
    Ho = (e) => {
      if (0 === e.length) throw new Error('Compose must have at least one element in the list')
            ...
            : ((e, t, n, r) => {
                const o = n > 1 ? Mo(e) : Po(e, k.none()),
                  s = o
                    ...
                    .getOr([]),
                  a = ((e, t, n, r) =>
                    ((e, t, n) => jo(e, (e) => e.level() < t, n))(e, n, (e) =>
                      ((e, t, n, r) => {
                        const o =
                            e.level() === n - 1 && t.type ? { 'list-style-type': t.type } : {},
                          s = Fo(e, t, o),
  ...
  const Yo = { inside: () => Zo, outside: () => Qo },
    Xo = (() => {
      let e = !1
      return {
        check: (t) =>
          !(!e || t.type() !== mo) ||
          (t.type() === uo && 'style' === t.tag()
            ? ((e = !0), !0)
            : t.type() === ho && 'style' === t.tag() && ((e = !1), !0))
      }
    })(),
    Zo = ((e) =>
      _o(
    ...
    Qo = ((e) =>
      _o(
        'Outside.List.Item',
        [
          No(Oo, Lo(e), 'Data List ****'),
          No(
            (e, t) =>
              t.type() === mo && ((e) => e.type() === mo && /^[\s\u00A0]*$/.test(e.text()))(t),
            (e, t, n) => {
              e.emit(n)
            },
            'Whitespace'
        ...
        (t, n, r) => {
          n.emitter.closeAllLists(), t.emit(r), Io(n, e.outside())
        }
      ))(Yo),
    es = ((e) => {
      const t = pe(e),
              ...
              ((e, t) => {
                ...
                return {
                  ...
                  openItem: (e, t, o) => {
                    if (!o) return
                    const s = ((e, t) =>
                        'ul' === e.tag && qo[t - 1] === e.type ? { tag: 'ul' } : e)(o, e),
                      a = Vo(n, e, t, s)
                    ;(n = a.state()), r(a)
                  },
  ...
  const ns = (e) => e.dom.textContent,
    ...
    cs = (e, t) => {
      const n = ((e, t) => {
        const n = ss[e] ? [ss[e]] : [],
          r = ((e, t) => (t && os[e] ? [os[e]] : t ? [{ tag: 'ul', variant: e }] : []))(e, t),
          o = R(rs, (t) =>
            t.regex.test(e) ? [Yr(t.type, is(e), { variant: as(t.type, e) })] : []
          ),
          s = n.concat(r).concat(o)
        return A(s, (t) => (void 0 !== t.variant ? t : Yr(t, { variant: e })))
      })(ns(e).trim(), t)
    ...
    hs = (e) =>
      Ce(e) && Wn(e, 'font-family').exists((e) => T(['wingdings', 'symbol'], e.toLowerCase())),
    ms = (e, t, n, r) => {
      ;((e, t, n) => {
        ...
        ((e) => {
          const t = ((e, t) => {
            ...
            return ((e) => {
              const t = []
              for (; null !== e.nextNode(); ) t.push(_e.fromDom(e.currentNode))
              return t
            })(
              document.createTreeWalker(e.dom, NodeFilter.SHOW_COMMENT, {
                acceptNode: (e) =>
                  n(e.nodeValue) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT
              })
            )
          })(e, k.none())
          O(t, gn)
            ...
            'p' !== xe(e)
              ...
              : ds(e).bind((t) => {
                  const n = jt(t).getOr(t),
                    r = hs(n)
                  return cs(t, r).bind((t) =>
                    ((e) =>
                      Wn(e, 'margin-left').bind((e) => {
    ...
    vs = (e) => {
      ...
      Se(o)
        ? ((t = o),
          (n = 'v:shape'),
          k.from(((r = t), r.dom.nodeValue)).bind((e) => {
            const t = e.indexOf(']>'),
              r = ((e) => {
                try {
        ...
        return (
          ...
          })(r, { width: Wn(e, 'width'), height: Wn(e, 'height') }),
          r
        )
      })
      var t, n, r, o
  ...
  var bs
  !(function (e) {
    ;(e[(e.Word = 0)] = 'Word'), (e[(e.GoogleDocs = 1)] = 'GoogleDocs'), (e[(e.Html = 2)] = 'Html')
  })(bs || (bs = {}))
  const xs = (e) => (t) => {
    ...
    Is = (e) => ((e) => ({ value: Cs(e) }))(Ts(e.red) + Ts(e.green) + Ts(e.blue)),
    As = /^\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)\s*$/i,
    Os = /^\s*rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?(?:\.\d+)?)\s*\)\s*$/i,
    Es = (e, t, n, r) => ({ red: e, green: t, blue: n, alpha: r }),
    Ls = (e, t, n, r) => {
    ...
    _s = (e) => {
      return 'currentcolor' === e || 'transparent' === e
        ? e
        : '#' +
            ((t = z(e, '#').toUpperCase()),
            ((e) => ws.test(e) || Ss.test(e))(t) ? k.some({ value: Cs(t) }) : k.none())
              .orThunk(() =>
                ((e) => {
                  if ('transparent' === e) return k.some(Es(0, 0, 0, 0))
                  const t = As.exec(e)
                  if (null !== t) return k.some(Ls(t[1], t[2], t[3], '1'))
                  const n = Os.exec(e)
      ...
      switch (t) {
        ...
        default:
          return $(t, '-color')
            ...
            : ((e) =>
                e.replace(
                  /^0(pt|px|pc|in|cm|mm|Q|cap|ch|ic|em|ex|lh|rlh|rem|vw|vh|vb|vi|vmax|vmin|%)$/,
                  '0'
                ))(e)
      }
    },
        ...
        tags: [
          {
            ...
            mutate: xs({ attrName: 'width', mapValue: (e) => e.replace(/^(\d+)$/, '$1px') })
          }
        ]
      })
    ],
        ...
        tags: [
          {
            ...
            mutate: (t) => {
              var n, r
              ;((n = $n(t)), (r = e.key), Be(n, r) ? k.from(n[r]) : k.none()).exists((t) =>
                T(e.values, t)
              ) &&
                (hn(t, _e.fromTag(e.newTag)),
                Vn(t, e.key),
    ...
    Us = [
      Fs({ matchTag: 'span', key: 'font-weight', values: ['700', 'bold'], newTag: 'strong' }),
      Fs({ matchTag: 'span', key: 'font-style', values: ['italic'], newTag: 'em' }),
      Fs({
        matchTag: 'span',
        key: 'vertical-align',
        values: ['sub'],
    ...
    Bs = (e) => (t) => {
      ...
      const s = A(n, (e) => {
        ...
        return { fake: t, me: n, toRemove: s, toPreserve: a }
      })
      O(s, (e) => {
    ...
    Hs = (e) => {
      ...
      return xo({
        styles: [
          ...
          { name: to.exact('overflow-wrap', to.caseInsensitive), condition: ks },
          {
          ...
          { name: to.starts('padding', to.caseInsensitive), condition: ks },
          {
            name: to.pattern(
              /^text-decoration(-(line|thickness|style|color))?$/,
              to.caseInsensitive
            ),
        ...
        attributes: [
          { name: to.exact('aria-level', to.caseInsensitive), condition: Oe('li') },
          {
      ...
      tags: [
        {
          ...
          mutate: (e) => {
            const t = Gn(e)
            Vn(e, 'text-indent'), Vn(e, 'rtl' === t ? 'padding-right' : 'padding-left')
          }
        }
      ]
    }),
    ...
    Js = (e, t) => {
      ...
      const o = zt(t)
      return pn(n, o), gn(t), n
    },
    Ys = Oe('li'),
    Xs = (e) =>
      Ft(e).bind((e) =>
        Te(e) && 0 === qs(e).trim().length ? Xs(e) : Ys(e) ? k.some(e) : k.none()
      ),
    Zs = (e) => {
      const t = Js('span', e),
        n = {
      ...
      Re({ face: 'font-family', size: 'font-size', color: 'color' }, (e, r) => {
        Tn(t, r).each((o) => {
          const s = n[e],
    ...
    Qs = xo({
      tags: [
        ...
        { name: to.exact('style', to.caseInsensitive), condition: (e) => 0 === Kn(e).length }
      ],
      attributes: [
      ...
      styles: [{ name: to.all(), value: to.pattern(/OLE_LINK/i, to.caseInsensitive) }]
    }),
    ea = xo({ tags: [{ name: to.exact('meta', to.caseInsensitive) }] }),
    ta = xo({ tags: [{ name: to.exact('style', to.caseInsensitive) }] }),
    na = xo({
      styles: [
        {
    ...
    ra = (e = []) => {
      const t = A(e, (e) => ({ name: to.exact(e, to.caseInsensitive) }))
      return ko({ tags: t })
    },
    oa = xo({ classes: [{ name: to.not(to.exact('rtf-data-image', to.caseInsensitive)) }] }),
    sa = xo({
      styles: [
        {
          name: to.pattern(
    ...
    aa = xo({ classes: [{ name: to.pattern(/mso/i, to.caseInsensitive) }] }),
    ia = ko({
      tags: [
        {
    ...
    la = ko({ tags: [{ name: to.exact('a', to.caseInsensitive), condition: Ks }] }),
    ca = xo({
      attributes: [
        { name: to.exact('style', to.caseInsensitive), value: to.exact('', to.caseInsensitive) }
      ]
    }),
    ua = xo({
      attributes: [
        { name: to.exact('class', to.caseInsensitive), value: to.exact('', to.caseInsensitive) }
      ]
    }),
    da = ko({
      tags: [
  ...
  const ma = wo({
    ...
    pa = (e) => {
      const t = Js('span', e)
      Nn(t, 'ephox-limbo-transform'), Un(t, 'text-decoration', 'underline')
    },
    fa = wo({
      tags: [
        {
              ...
              T(['ol', 'ul'], n) &&
                Xs(e).fold(
                  () => {
                    ...
                    Un(t, 'list-style-type', 'none'), hn(e, t)
                  },
                  (t) => {
                    dn(t, e)
                  }
    ...
    ga = (e) => {
      const t = [
          { name: 'b', transform: { mutate: g(Js, 'strong') } },
          { name: 'i', transform: { mutate: g(Js, 'em') } },
          { name: 'u', transform: { mutate: pa } },
          { name: 's', transform: { mutate: g(Js, 'strike') } },
          { name: 'font', transform: { mutate: Zs, debug: !0 } }
        ],
    ...
    va = xo({ classes: [{ name: to.exact('ephox-limbo-transform', to.caseInsensitive) }] }),
    ya = xo({
      tags: [
        { name: to.exact('br', to.caseInsensitive), condition: Vs('Apple-interchange-newline') }
      ]
    }),
    ba = xo({
      styles: [
        { name: to.pattern(/^-/, to.caseInsensitive) },
        { name: to.all(), value: to.exact('initial', to.caseInsensitive) },
        {
          name: to.exact('background-color', to.caseInsensitive),
          value: to.exact('transparent', to.caseInsensitive)
        },
        ...
        tags: [
          {
            ...
            mutate: (e) => {
              '\xa0' === ns(e) && (t(e) || n(e) ? vn(e) : (ln(e, _e.fromText(' ')), gn(e)))
            }
          }
        ]
      })
    ...
    Sa = (() => {
      ...
      return wo({ tags: [e('a', 'data-ephox-href', 'href'), e('img', 'data-ephox-src', 'src')] })
    })(),
    Ca = (e) => {
      ...
      r.each((n) => {
        o.each((r) => {
          ...
          for (; void 0 !== a && !It(a, e); )
            T(t, xe(a)) ? (o = a) : s.push(a), (a = jt(a).getOrUndefined())
          O(s, vn), O(Bt(o), gn)
        }),
          gn(n)
      }),
      ...
      tags: [
        {
          ...
          mutate: (e) => {
            Wn(e, 'margin-left').exists((e) => W(e, '-')) && Vn(e, 'margin-left'),
              W(zn(e, 'margin-left'), '-') &&
                (Un(e, 'margin-top', zn(e, 'margin-top')),
    ...
    Ia = wo({
      tags: [
        {
          name: to.exact('p', to.caseInsensitive),
          mutate: xs({ attrName: 'align', styleName: 'text-align', mapValue: p })
        }
      ]
    }),
    Aa = (e, t) => {
      return ((n = e), Gs.getOption(n)).exists((e) => 0 === t(e).length)
      var n
    },
    Oa = xo({
      tags: [
    ...
    La = wo({
      tags: [
        { name: to.exact('ol', to.caseInsensitive), mutate: Ea },
        { name: to.exact('ul', to.caseInsensitive), mutate: Ea }
      ]
    }),
    Na = ko({ tags: [{ name: to.pattern(/^([OVWXP]|U[0-9]+|ST[0-9]+):/i, to.caseInsensitive) }] }),
    _a = [So([gs])],
    Da = xo({
      attributes: [{ name: to.exact('height', to.caseInsensitive), condition: Oe('table') }]
    }),
    Pa = xo({
      attributes: [{ name: to.pattern(/^(width|height)$/, to.caseInsensitive), condition: ks }]
    }),
    Ra = wo({
      tags: [
        {
    ...
    Ma = xo({
      styles: [
        { name: to.exact('height', to.caseInsensitive), condition: Oe('td') },
        { name: to.exact('width', to.caseInsensitive), condition: Oe('tr') },
        { name: to.exact('height', to.caseInsensitive), condition: Oe('col') }
      ]
    }),
    ja = xo({
      attributes: [
  ...
  ko({
    tags: [
      {
        name: to.exact('p', to.caseInsensitive),
        condition: ('li', (e) => jt(e).exists((e) => 'li' === xe(e) && 1 === zt(e).length))
      }
    ]
  }),
    wo({
  ...
  const Ga = (e, t) => Ja(document.createElement('canvas'), e, t),
    qa = (e) => {
      ...
      return Ka(t).drawImage(e, 0, 0), t
    },
    Ka = (e) => e.getContext('2d'),
    Ja = (e, t, n) => ((e.width = t), (e.height = n), e),
    Ya = (e) => e.naturalWidth || e.width,
    Xa = (e) => e.naturalHeight || e.height,
    Za = (e) =>
      fetch(e).then(
        (e) =>
          e.ok ? e.blob() : Promise.reject(new Error('Error ' + e.status + ' downloading image')),
        () =>
          Promise.reject(
            (() => {
    ...
    Qa = (e) => {
      ...
      for (let e = 0; e < l; ++e) {
        const t = e * s,
          n = Math.min(t + s, i),
          r = new Array(n - t)
        for (let e = t, o = 0; e < n; ++o, ++e) r[o] = a[e].charCodeAt(0)
        c[e] = new Uint8Array(r)
      }
      return k.some(new Blob(c, { type: r }))
    },
    ei = (e) =>
      new Promise((t, n) => {
        Qa(e).fold(() => {
    ...
    ti = (e, t, n) => (
      (t = t || 'image/png'),
      c(HTMLCanvasElement.prototype.toBlob)
        ? new Promise((r, o) => {
            e.toBlob(
              (e) => {
                e ? r(e) : o()
            ...
            new Promise((t, n) => {
              const r = () => {
                ...
                o = [
                  Er(e, 'load', r),
                  Er(e, 'error', () => {
                    s(), n('Unable to load data from image: ' + e.dom.src)
                  })
                ],
                s = () => O(o, (e) => e.unbind())
              e.dom.complete && r()
    ...
    si = (e, t, n) => {
      const r = t.type,
        ...
        s = m(n),
        a = (t, n) =>
          e.then((e) => ((e, t, n) => ((t = t || 'image/png'), e.toDataURL(t, n)))(e, t, n))
      return {
        getType: o,
    ...
    ii = (e, t, n) => {
      ...
      let s = t / r,
        a = n / o,
        i = !1
      ;(s < 0.5 || s > 2) && ((s = s < 0.5 ? 0.5 : 2), (i = !0)),
        (a < 0.5 || a > 2) && ((a = a < 0.5 ? 0.5 : 2), (i = !0))
      const l = li(e, s, a)
    ...
    li = (e, t, n) =>
      new Promise((r) => {
        const o = Ya(e),
          ...
          i = Math.floor(s * n),
          l = Ga(a, i)
        Ka(l).drawImage(e, 0, 0, o, s, 0, 0, a, i), r(l)
      }),
    ci = (e, t = 2) => {
    ...
    ui = (e, t, n, r, o) =>
      ((e, t, n, r, o) =>
        e.toCanvas().then((s) =>
          ((e, t, n, r, o, s) => {
            const a = Ga(o, s)
            return Ka(a).drawImage(e, -n, -r), ai(a, t)
          })(s, e.getType(), t, n, r, o)
        ))(e, t, n, r, o),
    di = (e, t) =>
      ((e, t) =>
        e.toCanvas().then((n) =>
          ((e, t, n) => {
            const r = ((n < 0 ? 360 + n : n) * Math.PI) / 180,
              ...
              u = Ga(l, c),
              d = Ka(u)
            return d.translate(l / 2, c / 2), d.rotate(r), d.drawImage(e, -o / 2, -s / 2), ai(u, t)
          })(n, e.getType(), t)
        ))(e, t),
        ...
        .then(
          (
            (e) => (t) =>
              ((e, t, n) =>
                ((e, t, n) =>
                  e.toCanvas().then((r) => ii(r, t, n).then((t) => ai(t, e.getType()))))(e, t, n))(
                t,
                e.width,
                e.height
              )
        ...
        .then(
          ((e, t) => (n) => {
            if (vi(t)) {
              ...
              return ui(n, o, r, t.cropWidth, t.cropHeight).then(
                (n) => (Sn(e, { width: t.cropWidth, height: t.cropHeight }), n)
              )
            }
          ...
          (
            (e, t) => (n) =>
              ((e) => {
                ...
                () => Promise.resolve(n),
                (r) =>
                  di(n, r).then((n) => (Vn(t, 'transform'), An(e, 'width'), An(e, 'height'), n))
              )
          )(e, n)
        )
        .then((t) => {
          const n = fi(t)
          return wn(e, 'src', n), Promise.resolve()
        }),
    xi = (e) =>
      jt(e)
        .filter(Oe('span'))
  ...
  const wi = (e, t) => D(e, (e) => e.start === t),
    Si = (e, t, n = 0) =>
      N(e, (e, n) => t(n, e.len).fold(m(e), (t) => ({ len: t.finish, list: e.list.concat([t]) })), {
        len: n,
        list: []
      }).list,
    Ci = (e, t, n) =>
      0 === t.length
        ...
        : R(e, (e) => {
            const r = R(t, (t) =>
              ((e, t) => t >= e.start && t <= e.finish)(e, t) ? [t - e.start] : []
            )
            return r.length > 0
              ? ((e, t, n) =>
                  ((e, t) => A(e, (e) => ({ ...e, start: e.start + t, finish: e.finish + t })))(
                    n(e, t),
                    e.start
                  ))(e, r, n)
              : [e]
          }),
    Ti = (e, t, n) => ({ element: e, start: t, finish: n }),
    Ii = Lt([{ include: ['item'] }, { excludeWith: ['item'] }, { excludeWithout: ['item'] }]),
    Ai = {
      include: Ii.include,
    ...
    Ri = m([]),
    Mi = (e, t, n) => {
      if (e.property().isText(t)) return [Pi.text(t, e)]
      if (e.property().isEmptyTag(t)) return [Pi.empty(t, e)]
      ...
      const r = R(n, (e) => [e.start, e.finish]),
        o = Ci(t, r, (t, n) =>
          ((e, t, n) => {
            ...
            if (o.length <= 1) return [Ti(t, 0, r.length)]
            ...
            const s = Si(
              ...
              a = A(s, (e) => e.element)
            return e.insert().afterAll(t, a), [Ti(t, 0, o[0].length)].concat(s)
          })(e, t.element, n)
        )
      return A(n, (t) => {
        const n = ((e, t, n) => {
            ...
            return r
              .bind((t) => {
                const r = o.getOr(
                  ((e, t) => (e[e.length - 1] && e[e.length - 1].finish === t ? e.length + 1 : -1))(
                    e,
                    n
                  )
                )
          ...
          const r = R(t, (e) => e.fold(Ri, Ri, (e) => [e], Ri)),
            o = ((e, t) => {
              const n = R(t, (t) => {
                const n = ((e, t) => {
                  ...
                  for (; o; ) {
                    ...
                    r.push({ start: s, finish: s + a }), (n.lastIndex = s + a), (o = n.exec(e))
                  }
                  return r
                })(e, t.pattern)
                return A(n, (e) => ({ ...t, ...e }))
              ...
              return ((e) => {
                ...
                return t.sort((e, t) => (e.start < t.start ? -1 : t.start < e.start ? 1 : 0)), t
              })(n)
    ...
    zi = {
      ...
      down: m({ selector: Kt, predicate: qt }),
      styles: m({ get: zn, getRaw: Wn, set: Un, remove: Vn }),
      attrs: m({
        get: Cn,
        set: wn,
        remove: An,
        copyTo: (e, t) => {
          const n = N(e.dom.attributes, (e, t) => ((e[t.name] = t.value), e), {})
          Sn(t, n)
        }
      }),
      insert: m({
        ...
        return ((e, t, n) => Bi(zi, e, t, void 0))(e, [
          {
            ...
            pattern:
              ((t = Hi),
              ((e, t, n, r) => ({ term: () => new RegExp(e, r.getOr('g')), prefix: t, suffix: n }))(
                t,
                m(0),
                m(0),
                k.none()
          ...
          ;((e, t) => {
            k.from(e[0])
              ...
              .map((n) => {
                ...
                return ln(n, r), pn(r, e), wn(r, 'href', t), r
              })
          })(e.elements, r)
        }
      })
    ...
    Ji = {
      disabled: () => ({ discriminator: 'disabled', data: {} }),
      fromClipboard: (e) => ({ discriminator: 'fromClipboard', data: { rtf: e } })
    },
    Yi = De(Ji),
    Xi = Ji.disabled,
    Zi = Ji.fromClipboard,
    ...
    el = (e, t) => {
      ...
      return U(e, (e) => Rn(null !== n.exec(e), { type: e, flavor: t }))
    }
  function tl(e) {
    return (
      (tl =
  ...
  var vl,
    yl = El(Array.prototype.forEach),
    bl = El(Array.prototype.pop),
    xl = El(Array.prototype.push),
    kl = El(String.prototype.toLowerCase),
    wl = El(String.prototype.toString),
    Sl = El(String.prototype.match),
    Cl = El(String.prototype.replace),
    Tl = El(String.prototype.indexOf),
    Il = El(String.prototype.trim),
    Al = El(RegExp.prototype.test),
    Ol =
      ((vl = TypeError),
      function () {
  ...
  function Ll(e, t, n) {
    var r
    ;(n = null !== (r = n) && void 0 !== r ? r : kl), il && il(e, null)
  ...
  function Nl(e) {
    var t,
      n = ml(null)
    for (t in e) !0 === fl(al, e, [t]) && (n[t] = e[t])
    return n
  }
  function _l(e, t) {
    for (; null !== e; ) {
      var n = ul(e, t)
      if (n) {
        if (n.get) return El(n.get)
        if ('function' == typeof n.value) return El(n.value)
      }
      e = cl(e)
    }
    return function (e) {
  ...
  var Dl = dl([
    ...
    ec = (function e() {
      ...
      if (((n.version = '2.4.7'), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
      ...
      var k = (function (e, t) {
          if ('object' !== tl(e) || 'function' != typeof e.createPolicy) return null
          var n = null,
      ...
      var N,
        ...
        B = Jl,
        z = null,
        H = Ll({}, [].concat(ol(Dl), ol(Pl), ol(Rl), ol(jl), ol(Ul))),
        W = null,
        $ = Ll({}, [].concat(ol(Bl), ol(zl), ol(Hl), ol(Wl))),
        V = Object.seal(
          Object.create(null, {
        ...
        he = null,
        me = Ll({}, ['audio', 'video', 'img', 'source', 'image', 'track']),
        pe = null,
        fe = Ll({}, [
          'alt',
          'class',
        ...
        ke = null,
        we = Ll({}, [ge, ve, ye], wl),
        Se = ['application/xhtml+xml', 'text/html'],
        Ce = null,
        ...
        Ae = function (e) {
          ;(Ce && Ce === e) ||
            ...
            ce &&
              ((z = Ll({}, ol(Ul))),
              (W = []),
              !0 === ce.html && (Ll(z, Dl), Ll(W, Bl)),
              !0 === ce.svg && (Ll(z, Pl), Ll(W, zl), Ll(W, Wl)),
              !0 === ce.svgFilters && (Ll(z, Rl), Ll(W, zl), Ll(W, Wl)),
              !0 === ce.mathMl && (Ll(z, jl), Ll(W, Hl), Ll(W, Wl))),
            e.ADD_TAGS && (z === H && (z = Nl(z)), Ll(z, e.ADD_TAGS, _)),
            e.ADD_ATTR && (W === $ && (W = Nl(W)), Ll(W, e.ADD_ATTR, _)),
            e.ADD_URI_SAFE_ATTR && Ll(pe, e.ADD_URI_SAFE_ATTR, _),
            e.FORBID_CONTENTS && (ue === de && (ue = Nl(ue)), Ll(ue, e.FORBID_CONTENTS, _)),
            ie && (z['#text'] = !0),
            Q && Ll(z, ['html', 'head', 'body']),
            z.table && (Ll(z, ['tbody']), delete G.tbody),
            dl && dl(e),
            (Ce = e))
        },
        Oe = Ll({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
        Ee = Ll({}, ['foreignobject', 'desc', 'title', 'annotation-xml']),
        Le = Ll({}, ['title', 'style', 'font', 'a', 'script']),
        Ne = Ll({}, Pl)
      Ll(Ne, Rl), Ll(Ne, Ml)
      var _e = Ll({}, jl)
      Ll(_e, Fl)
      var De = function (e) {
          xl(n.removed, { element: e })
          try {
        ...
        Pe = function (e, t) {
          try {
            xl(n.removed, { attribute: t.getAttributeNode(e), from: t })
          } catch (e) {
            xl(n.removed, { attribute: null, from: t })
          }
        ...
        Ue = function (e) {
          ...
          if (
            ...
            return De(e), !0
          if (Al(/[\u0080-\uFFFF]/, e.nodeName)) return De(e), !0
          var o = _(e.nodeName)
          if (
            (Fe('uponSanitizeElement', e, { tagName: o, allowedTags: z }),
            e.hasChildNodes() &&
              !je(e.firstElementChild) &&
              (!je(e.content) || !je(e.content.firstElementChild)) &&
              Al(/<[/\w]/g, e.innerHTML) &&
              Al(/<[/\w]/g, e.textContent))
          )
            return De(e), !0
          if ('select' === o && Al(/<template/i, e.innerHTML)) return De(e), !0
          if (!z[o] || G[o]) {
            if (!G[o] && ze(o)) {
              if (V.tagNameCheck instanceof RegExp && Al(V.tagNameCheck, o)) return !1
              if (V.tagNameCheck instanceof Function && V.tagNameCheck(o)) return !1
            }
            if (ie && !ue[o]) {
              var s = b(e) || e.parentNode,
                a = y(e) || e.childNodes
              if (a && s) for (var i = a.length - 1; i >= 0; --i) s.insertBefore(g(a[i], !0), v(e))
            }
            return De(e), !0
          }
          return e instanceof l &&
              ...
              return (
                ...
                (e.namespaceURI === ve
                  ...
                  ? t.namespaceURI === ye
                    ...
                    : Boolean(_e[n])
                  : e.namespaceURI === ye
                  ? !(t.namespaceURI === ve && !Ee[r]) &&
                    !(t.namespaceURI === ge && !Oe[r]) &&
                    !_e[n] &&
                    (Le[n] || !Ne[n])
            ...
            : ('noscript' !== o && 'noembed' !== o && 'noframes' !== o) ||
              !Al(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? (Z &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = Cl(t, D, ' ')),
                ...
                (t = Cl(t, R, ' ')),
                e.textContent !== t &&
                  (xl(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
              Fe('afterSanitizeElements', e, null),
              !1)
            : (De(e), !0)
        },
        Be = function (e, t, n) {
          if (se && ('id' === t || 'name' === t) && (n in o || n in Te)) return !1
          if (J && !q[t] && Al(M, t));
          else if (K && Al(j, t));
          else if (!W[t] || q[t]) {
            if (
              !(
                (ze(e) &&
                  ((V.tagNameCheck instanceof RegExp && Al(V.tagNameCheck, e)) ||
                    (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                  ((V.attributeNameCheck instanceof RegExp && Al(V.attributeNameCheck, t)) ||
                    (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                ('is' === t &&
                  V.allowCustomizedBuiltInElements &&
                  ((V.tagNameCheck instanceof RegExp && Al(V.tagNameCheck, n)) ||
        ...
        He = function (e) {
          ...
          var a = e.attributes
          if (a) {
            var i = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: W }
            for (s = a.length; s--; ) {
              var l = (t = a[s]),
                c = l.name,
                u = l.namespaceURI
              if (
                ((r = 'value' === c ? t.value : Il(t.value)),
                (o = _(c)),
                (i.attrName = o),
                (i.attrValue = r),
                (i.keepAttr = !0),
                ...
                (r = i.attrValue),
                !i.forceKeepAttr && (Pe(c, e), i.keepAttr))
              )
                if (X || !Al(/\/>/i, r)) {
                  Z && ((r = Cl(r, D, ' ')), (r = Cl(r, P, ' ')), (r = Cl(r, R, ' ')))
                  var d = _(e.nodeName)
                  if (Be(d, o, r)) {
                    if (
                      (!ae || ('id' !== o && 'name' !== o) || (Pe(c, e), (r = 'user-content-' + r)),
                    ...
                    try {
                      u ? e.setAttributeNS(u, c, r) : e.setAttribute(c, r), bl(n.removed)
                    } catch (e) {}
                  }
                } else Pe(c, e)
            }
        ...
        We = function e(t) {
          ...
          for (Fe('beforeSanitizeShadowDOM', t, null); (n = r.nextNode()); )
            Fe('uponSanitizeShadowNode', n, null),
              Ue(n) || (n.content instanceof s && e(n.content), He(n))
      ...
      return (
        (n.sanitize = function (e) {
          ...
          if (((xe = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !je(e))) {
            if ('function' != typeof e.toString) throw Ol('toString is not a function')
            if ('string' != typeof (e = e.toString())) throw Ol('dirty is not a string, aborting')
          }
          if (!n.isSupported) {
          ...
          if ((ee || Ae(d), (n.removed = []), 'string' == typeof e && (le = !1), le)) {
            if (e.nodeName) {
              var h = _(e.nodeName)
              if (!z[h] || G[h]) throw Ol('root node is forbidden and cannot be sanitized in-place')
            }
          } else if (e instanceof i)
            (1 === (a = (o = Re('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
              'BODY' === a.nodeName) ||
            'HTML' === a.nodeName
              ? (o = a)
              : o.appendChild(a)
          else {
            if (!ne && !Z && !Q && -1 === e.indexOf('<')) return k && oe ? k.createHTML(e) : e
            if (!(o = Re(e))) return ne ? null : oe ? w : ''
          }
          o && te && De(o.firstChild)
          for (var m = Me(le ? e : o); (l = m.nextNode()); )
            (3 === l.nodeType && l === c) ||
              Ue(l) ||
              (l.content instanceof s && We(l.content), He(l), (c = l))
          if (((c = null), le)) return e
          if (ne) {
            if (re) for (u = I.call(o.ownerDocument); o.firstChild; ) u.appendChild(o.firstChild)
            else u = o
            return (W.shadowroot || W.shadowrootmod) && (u = O.call(r, u, !0)), u
          }
          ...
          return (
            Q &&
              ...
              Al(Zl, o.ownerDocument.doctype.name) &&
              (p = '<!DOCTYPE ' + o.ownerDocument.doctype.name + '>\n' + p),
            Z && ((p = Cl(p, D, ' ')), (p = Cl(p, P, ' ')), (p = Cl(p, R, ' '))),
        ...
        (n.addHook = function (e, t) {
          'function' == typeof t && ((L[e] = L[e] || []), xl(L[e], t))
        }),
        (n.removeHook = function (e) {
          if (L[e]) return bl(L[e])
        }),
  ...
  const tc = ['script', 'svg'],
          ...
          : ((e, t) => {
              ec.addHook('uponSanitizeElement', (e, t) => {
                ...
                ec.addHook('uponSanitizeAttribute', (e, t) => {
                  0 === t.attrName.indexOf('on') ||
                    Be(t.allowedAttributes, t.attrName) ||
                    (t.allowedAttributes[t.attrName] = !0),
                    t.attrValue &&
                      -1 !== t.attrValue.indexOf('\n') &&
                      (t.attrValue = t.attrValue.replace(/\r?\n/g, ''))
                })
              const n = ((e) => W(V(e), '<!'))(e),
                r = n
                  ? `<body>${e}</body>`
                  : ((e) => e.replace(/^[\S\s]*?(<!DOCTYPE|<html)/i, '$1'))(e),
                o = ec.sanitize(r, {
              ...
              return (
                ec.removeHook('uponSanitizeElement'),
                ec.removeHook('uponSanitizeAttribute'),
                n
                  ? ((s = z(o, '<body>')),
                    $(s, '</body>') ? ((e, t) => e.substring(0, e.length - 7))(s) : s)
                  : o
              )
              var s
            })(t),
    ...
    oc = { sanitizeHtml: p, sanitizeText: p },
    sc = (e) => (t) => ({ discriminator: e, data: t }),
    ...
    yc = (e) =>
      ((e) =>
        H(e, '<html') &&
        (H(e, 'xmlns:o="urn:schemas-microsoft-com:office:office"') ||
          H(e, 'xmlns:x="urn:schemas-microsoft-com:office:excel"')))(e) ||
      ((e) => H(e, 'meta name="ProgId" content="Word.Document"'))(e),
    bc = (e) => H(e, 'id="docs-internal-guid-'),
    xc = (e) => e.length > 0,
    kc = (e, t) =>
      el(e.types, t)
        .map((t) => e.getData(t.type))
        .filter(xc),
    wc = (e) => kc(e, 'html'),
    Sc = (e) => wc(e).filter(bc),
    ...
    Ec = (e, t, n) => {
      ...
      const s = (n, o) => {
        ...
        const s = ((e, t, n) => {
          const r = ((e, t) =>
            U(e, (e) => e.getAvailable(t).map((t) => qr(e.steps, t, e.label, e.capture()))))(e, n)
          return r.getOrThunk(() => {
        ...
        a.then((e) => {
          ...
          r.trigger.block(!1),
            Rr(
              ...
              (e, o, s) => {
                r.trigger.insert(e, Oc(o), o, t, i, n), r.trigger.error(s)
              }
            )
        })
      }
              ...
              const t = ((e, t = oc) => {
                const n = (e) => {
                    return void 0 === e.items
                      ? k.none()
                      : ((t = vc), (n = e.types), U(t, (e) => el(n, e))).map((t) => {
                          const n = []
                  ...
                  r = (e) =>
                    U(e.types, (n) =>
                      'text/plain' === n
                        ? k.some(e.getData(n)).map((e) => dc({ text: t.sanitizeText(e) }))
                        : k.none()
                    )
                return {
                  getWordData: () =>
                    Cc(e).bind((e) =>
                      ((e) => wc(e).filter(yc))(e).map((t) => {
                  ...
                  getGoogleDocsData: () =>
                    Cc(e)
                      .bind(Sc)
                      .map((e) => t.sanitizeHtml(e, 'googledocs'))
                      .map(Tc),
  ...
  var Nc = {
    ...
    ...Lt([{ blob: ['id', 'imageresult', 'objurl'] }, { url: ['id', 'url', 'raw'] }])
  }
  const _c = (e) => {
      const t = URL.createObjectURL(e)
      return Dc(e, t)
    ...
    Rc = (e, t) => ({ asset: e, image: t }),
    Mc = (e, t) => Nc.cata(e, (e, n, r) => (wn(t, 'src', r), !0), b),
    jc = (e, t) => {
      const n = []
      return (
        O(e, (e, r) => {
    ...
    Fc = (e, t) => ({ asyncAsset: e.then(Tr.value, Tr.error), image: t }),
    Uc = (e) => {
      const t = _e.fromTag('div')
      return pn(t, e), Kt(t, 'img[src]')
    },
    ...
    Wc = (e) =>
      R(Uc(e), (e) => {
        ...
        return Bc(t)
          ? ((e, t) => {
              return ((n = t), Qa(n)).map((t) => Fc(_c(t), e))
              var n
            })(e, t).toArray()
          : zc(t)
          ? ((e, t) => {
              return ((n = t),
              k.from(
                0 === (r = n).indexOf('blob:') ? Za(r) : 0 === r.indexOf('data:') ? ei(r) : null
              )).map((t) => {
                const n = t.then(_c)
                return Fc(n, e)
              })
  ...
  var Vc = (e) => (t, n) => {
    const r = () => Promise.resolve(n),
      o = (t, o) =>
        !1 === e.allowLocalImages
          ? ((e) => {
              const t = L(Uc(e), Hc)
              return (
                O(t, gn),
                Promise.resolve({ response: t.length > 0 ? $c(e) : n.response, bundle: n.bundle })
              )
            })(t)
          : 0 === o.length
          ? ((e) => {
  ...
  const Gc = (e, t, n = !1) =>
      fetch(e, { credentials: n ? 'include' : 'same-origin', headers: t }).then(
        async (e) => {
    ...
    Zc = (e, t, n = !0) =>
      t
        ? ((e, t) => {
            const n = { 'Content-Type': 'application/json;charset=UTF-8', 'tiny-api-key': t }
            return Gc(
              ((e, t) => {
                const n = -1 === e.indexOf('?') ? '?' : '&'
        ...
        : ((e, t) => Gc(e, {}, t).then((e) => (e.ok ? Promise.resolve(e.blob) : Jc(e.status))))(
            e,
            n
          ),
    Qc =
    ...
    ru = (e, t) => {
      const n = () => Promise.resolve({ response: t.response, bundle: t.bundle }),
        r = (e) =>
          Lc(e).then((t) => {
            const n = xn('image'),
              r = hi(e, t),
        ...
        s = (e, n) => {
          ...
          return Promise.all(
            ...
            () => ({ response: Mr('errors.imageimport.invalid'), bundle: t.bundle })
          )
        }
    ...
    uu = (e, t) => {
      const n = ((e, t) => {
        const n = t.translations,
          r = (e) => k.some(Yr(t, { officeStyles: e, gdocsStyles: e, htmlStyles: e }))
        return {
          get: (o) => {
            const s = ((e) => {
                switch (e) {
      ...
      return (e, t) => {
        const r = t.bundle,
          o = t.response
        return n.get(cu(r)).then((e) =>
          e.fold(
            () => ({ response: Fr(), bundle: t.bundle }),
            (e) => ({
              response: o,
              bundle: Hr({
    ...
    du = (e, t) => (n, r) =>
      lu(r.bundle)
        ? ((e) =>
            Promise.resolve({
              response: r.response,
              bundle: Hr({ officeStyles: e, gdocsStyles: e, htmlStyles: e })
            }))(!0)
        : uu(e, t)(n, r),
    hu = (e, t) => {
      if (!Gt(e))
      ...
      const n = ((e) =>
          ((e) => {
            const t = e.dom
            try {
              return ((e, t) => (null != e ? k.some(t(e)) : k.none()))(
                t.contentWindow ? t.contentWindow.document : t.contentDocument,
                _e.fromDom
              )
            } catch (e) {
              return (
                console.log('Error reading iframe: ', t), console.log('Error was: ' + e), k.none()
              )
            }
          })(e).getOrThunk(() => Pt(e)))(e),
        r = n.dom
  ...
  var mu = Object.create,
    ...
    bu = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    xu = (e, t) => {
      for (var n in t) pu(e, n, { get: t[n], enumerable: !0 })
    },
    ku = bu((e) => {
    ...
    wu = bu((e) => {
      ...
      ;(e.encode = function (e) {
        var n,
          ...
          s = (r = e) < 0 ? 1 + (-r << 1) : 0 + (r << 1)
        do {
          ;(n = 31 & s), (s >>>= 5) > 0 && (n |= 32), (o += t.encode(n))
        } while (s > 0)
        return o
      }),
      ...
      var s = (function (t) {
        ...
        return function (t) {
          for (var s = 0; s < n.length; s++)
            if (n[s].input === t) {
              var a = n[0]
              return (n[0] = n[s]), (n[s] = a), n[0].result
            }
          var i = (function (t) {
            var n = t,
              s = r(t)
            ...
            for (var a = e.isAbsolute(n), i = [], l = 0, c = 0; ; ) {
              ...
              for (i.push(n.slice(l, c)); c < n.length && '/' === n[c]; ) c++
            }
            var u,
              d = 0
            for (c = i.length - 1; c >= 0; c--)
              '.' === (u = i[c])
                ...
                : '..' === u
                ? d++
                : d > 0 && ('' === u ? (i.splice(c + 1, d), (d = 0)) : (i.splice(c, 2), d--))
            return '' === (n = i.join('/')) && (n = a ? '/' : '.'), s ? ((s.path = n), o(s)) : n
          })(t)
          return n.unshift({ input: t, result: i }), n.length > 32 && n.pop(), i
        }
      })()
      function a(e, t) {
        '' === e && (e = '.'), '' === t && (t = '.')
    ...
    Cu = bu((e) => {
      ...
      ;(o.fromArray = function (e, t) {
        ...
        (o.prototype.add = function (e, o) {
          ...
          ;(!a || o) && this._array.push(e), a || (r ? this._set.set(e, i) : (this._set[s] = i))
        }),
    ...
    Iu = bu((e) => {
      ...
      ;(s.prototype._version = 3),
        (s.fromSourceMap = function (e) {
          var t = e.sourceRoot,
            r = new s({ file: e.file, sourceRoot: t })
          return (
            e.eachMapping(function (e) {
              var o = { generated: { line: e.generatedLine, column: e.generatedColumn } }
              null != e.source &&
                ((o.source = e.source),
            ...
            e.sources.forEach(function (o) {
              var s = o
              null !== t && (s = n.relative(t, o)), r._sources.has(s) || r._sources.add(s)
        ...
        (s.prototype._serializeMappings = function () {
          for (
            ...
            if (((e = ''), (r = m[p]).generatedLine !== i))
              for (a = 0; r.generatedLine !== i; ) (e += ';'), i++
            else if (p > 0) {
              if (!n.compareByGeneratedPositionsInflated(r, m[p - 1])) continue
              e += ','
            }
            ;(e += t.encode(r.generatedColumn - a)),
              ...
              null != r.source &&
                ...
                (l = r.originalColumn),
                null != r.name &&
                  ((o = this._names.indexOf(r.name)), (e += t.encode(o - u)), (u = o))),
              (h += e)
          }
          return h
        }),
  ...
  function Qu(e, t) {
    ...
    if (
      ...
      Au(n) && ((t = Yu(e, t + 1)), (n = e.charCodeAt(t))),
  ...
  function td(e) {
    if (1 === e.length && !Ou(e.charCodeAt(0))) return e[0]
    let t = parseInt(e, 16)
    return (
      (0 === t || (t >= 55296 && t <= 57343) || t > 1114111) && (t = 65533), String.fromCodePoint(t)
    )
  }
  var nd = [
    'EOF-token',
  ...
  function od(e) {
    ...
    for (let e = r; e < n; e++) {
      ...
      ;(o[e] = a),
        (s[e] = i++),
        (10 === r || 13 === r || 12 === r) &&
          (13 === r && e + 1 < n && 10 === t.charCodeAt(e + 1) && (e++, (o[e] = a), (s[e] = i)),
          a++,
          (i = 1))
    }
    ;(o[n] = a), (s[n] = i), (e.lines = o), (e.columns = s), (e.computed = !0)
  }
  var sd = 16777215,
    ad = 24,
    id = new Map([
  ...
  function ld(e, t) {
    ...
    function s(t) {
      for (t || (t = n(c++)), a = 5; c < e.length; c++) {
        let r = e.charCodeAt(c)
        switch ($u(r)) {
          case t:
            return void c++
          case Bu:
            if (Du(r)) return (c += Gu(e, c, r)), void (a = 6)
            break
          case 92:
    ...
    for (; c < i; ) {
      ...
      switch ($u(i)) {
        ...
        case 34:
          ...
          break
        case 35:
          Nu(n(c + 1)) || Ru(n(c + 1), n(c + 2)) ? ((a = 4), (c = Zu(e, c + 1))) : ((a = 9), c++)
          break
        case 39:
          s()
          break
        ...
        case 47:
          42 === n(c + 1)
            ? ((a = 25), (c = e.indexOf('*/', c + 2)), (c = -1 === c ? e.length : c + 2))
            : ((a = 9), c++)
          break
        case 58:
          ;(a = 16), c++
        ...
        case 60:
          ...
          break
        case 64:
          Mu(n(c + 1), n(c + 2), n(c + 3)) ? ((a = 3), (c = Zu(e, c + 1))) : ((a = 9), c++)
          break
        case 91:
          ;(a = 19), c++
          break
      ...
      ((e, t, n, r) => {
        if ((t && 'object' == typeof t) || 'function' == typeof t)
          for (let n of gu(t))
            !yu.call(e, n) &&
              'default' !== n &&
              pu(e, n, { get: () => t[n], enumerable: !(r = fu(t, n)) || r.enumerable })
        return e
      })(
        ((e) => pu(e, '__esModule', { value: !0 }))(
          pu(null != cd ? mu(vu(cd)) : {}, 'default', { value: cd, enumerable: !0 })
        ),
        cd
      )),
    dd = new Set(['Atrule', 'Selector', 'Declaration']),
    hd = {}
  xu(hd, { safe: () => yd, spec: () => vd })
  var md = (e, t) => {
  ...
  function Id(e, t) {
    let n = this.tokenStart + e,
      r = this.charCodeAt(n)
    for (
      (r === wd || r === Sd) && (t && this.error('Number sign is not allowed'), n++);
      n < this.tokenEnd;
      n++
    )
  ...
  function Ed() {
    ...
    if (10 !== n) {
      if (!this.isDelim(wd, e) && !this.isDelim(Sd, e)) return null
      t = this.isDelim(wd, e) ? wd : Sd
      do {
        n = this.lookupType(++e)
      } while (13 === n || 25 === n)
      10 !== n && (this.skip(e), Ad.call(this, Td))
    }
    return (
      e > 0 && this.skip(e),
      0 === t &&
  ...
  function Ld() {
    let e = this.tokenStart,
      t = null,
      n = null
    if (10 === this.tokenType) Ad.call(this, !1), (n = this.consume(10))
    else if (1 === this.tokenType && this.cmpChar(this.tokenStart, Sd))
      switch (((t = '-1'), Od.call(this, 1, Cd), this.tokenEnd - this.tokenStart)) {
        case 2:
          this.next(), (n = Ed.call(this))
          break
        case 3:
          Od.call(this, 2, Sd),
            this.next(),
          ...
          break
        default:
          Od.call(this, 2, Sd), Id.call(this, 3, Td), this.next(), (n = this.substrToCursor(e + 2))
      }
    else if (1 === this.tokenType || (this.isDelim(wd) && 1 === this.lookupType(1))) {
      let r = 0
      switch (
        ((t = '1'),
        this.isDelim(wd) && ((r = 1), this.next()),
        Od.call(this, 0, Cd),
      ...
      s === this.tokenStart + o && this.error('Integer is expected', this.tokenStart + o),
        ...
        s + 1 === this.tokenEnd
          ? (this.next(), (n = Ed.call(this)))
          : (Od.call(this, s - this.tokenStart + 1, Sd),
            s + 2 === this.tokenEnd
              ? (this.next(), this.skipSC(), Ad.call(this, Td), (n = '-' + this.consume(10)))
              : (Id.call(this, s - this.tokenStart + 2, Td),
                this.next(),
                (n = this.substrToCursor(s + 1))))
    } else this.error()
    return (
      null !== t && t.charCodeAt(0) === wd && (t = t.substr(1)),
  ...
  function Bd() {
    ...
    let e = this.tokenStart,
      t = !1
    return (
      this.isDelim(Rd) ? ((t = !0), this.next()) : this.isDelim(Fd) || this.eat(1),
      this.isDelim(Fd)
        ? this.charCodeAt(this.tokenStart + 1) !== Md
  ...
  function zd() {
    ...
    return (
      ...
      this.next(),
      t !== Md && (this.isDelim(Md) || this.error('Equal sign is expected'), this.next()),
  ...
  function Qd(e) {
    this.token(1, e.property),
      ...
      this.node(e.value),
      e.important &&
        (this.token(9, '!'), this.token(1, !0 === e.important ? 'important' : e.important))
  }
  function eh(e) {
    this.children(e, (e) => {
      'Declaration' === e.type && this.token(17, ';')
  ...
  function dh() {
    let e = this.tokenStart
    return this.eatDelim(38), { type: 'NestingSelector', loc: this.getLocation(e, this.tokenStart) }
  }
  function hh() {
    this.token(9, '&')
  }
  ...
  function Mh(e) {
    ...
    for (let n = r; n <= o; n++) {
      ...
      if (r === Dh) {
        ...
        if (((r = e.charCodeAt(++n)), Ru(Dh, r))) {
          let t = n - 1,
            r = Xu(e, t)
          ;(n = r - 1), (s += td(e.substring(t + 1, r)))
        ...
        for (let t = 0; t < e.length; t++) {
          ...
          0 !== s
            ? s <= 31 || 127 === s
              ...
              : s === n || s === Dh
              ? ((r += '\\' + e.charAt(t)), (o = !1))
              : (o && (Ou(s) || Pu(s)) && (r += ' '), (r += e.charAt(t)), (o = !1))
            : (r += '\ufffd')
        }
        return '"' + r + '"'
      })(e.value)
  ...
  function Hh() {
    ...
    return (
      this.isDelim(124)
        ? (this.next(), zh.call(this))
        : (zh.call(this), this.isDelim(124) && (this.next(), zh.call(this))),
      {
        type: 'TypeSelector',
        loc: this.getLocation(e, this.tokenStart),
        name: this.substrToCursor(e)
      ...
      (function (e) {
        ...
        for (let r = 0; r < e.length; r++) {
          ...
          0 !== o
            ? o <= 31 || 127 === o
              ? ((t += '\\' + o.toString(16)), (n = !0))
              : o === Vh || o === Gh || o === qh || o === Kh || o === Jh || o === Yh
              ? ((t += '\\' + e.charAt(r)), (n = !1))
              : (n && Ou(o) && (t += ' '), (t += e.charAt(r)), (n = !1))
            : (t += '\ufffd')
        }
        return 'url(' + t + ')'
      })(e.value)
  ...
  Object.freeze({ type: 'WhiteSpace', loc: null, value: ' ' })
  var em = (function (e) {
      let t = new Map()
      for (let n in e.node) {
        let r = e.node[n]
              ...
              e.node = function (e) {
                if (e.loc && e.loc.start && dd.has(e.type)) {
                  ...
                  ;(r.line !== c || r.column !== u) &&
                    ...
                    (n.column = i),
                    l &&
                      ((l = !1), (n.line !== o.line || n.column !== o.column) && t.addMapping(s)),
                    (l = !0),
                    t.addMapping({ source: e.loc.source, original: r, generated: n }))
                }
                c.call(this, e), l && dd.has(e.type) && ((o.line = a), (o.column = i))
              }
              let u = e.emit
              e.emit = function (e, t, n) {
                for (let t = 0; t < e.length; t++) 10 === e.charCodeAt(t) ? (a++, (i = 0)) : i++
                u(e, t, n)
              }
              let d = e.result
              return (
                (e.result = function () {
                  return l && t.addMapping(s), { css: d(), map: t }
                }),
                e
              )
            })(s)),
    ...
    nm = class {
      ...
      allocateCursor(e, t) {
        ...
        return (
          null !== tm
            ? ((n = tm), (tm = tm.cursor), (n.prev = e), (n.next = t), (n.cursor = this.cursor))
      ...
      releaseCursor() {
        let { cursor: e } = this
        ;(this.cursor = e.cursor), (e.prev = null), (e.next = null), (e.cursor = tm), (tm = e)
      }
      updateCursors(e, t, n, r) {
        let { cursor: o } = this
        for (; null !== o; )
          o.prev === e && (o.prev = t), o.next === n && (o.next = r), (o = o.cursor)
      }
      *[Symbol.iterator]() {
      ...
      reduce(e, t, n = this) {
        let r,
          ...
          s = t
        for (; null !== o.next; )
          (r = o.next), (o.next = r.next), (s = e.call(n, s, r.data, r, this))
      ...
      reduceRight(e, t, n = this) {
        let r,
          ...
          s = t
        for (; null !== o.prev; )
          (r = o.prev), (o.prev = r.prev), (s = e.call(n, s, r.data, r, this))
        return this.releaseCursor(), s
      }
      some(e, t = this) {
  ...
  function am({ source: e, line: t, column: n }, r) {
    ...
    let s = e.split(/\r\n?|\n|\f/),
      ...
      c = 0
    ;(n += (sm.length - 1) * (s[t - 1].substr(0, n - 1).match(/\t/g) || []).length) > rm &&
      ((c = n - om + 3), (n = om - 2))
    for (let e = a; e <= i; e++)
      e >= 0 &&
        e < s.length &&
        ((s[e] = s[e].replace(/\t/g, sm)),
        (s[e] =
          (c > 0 && s[e].length > c ? '\u2026' : '') +
          s[e].substr(c, rm - 2) +
          (s[e].length > c + rm - 1 ? '\u2026' : '')))
  ...
  function im(e, t, n, r, o) {
    return Object.assign(
      ...
      })('SyntaxError', e),
      {
        ...
        line: r,
        column: o,
        sourceFragment: (e) => am({ source: t, line: r, column: o }, isNaN(e) ? 0 : e),
        get formattedMessage() {
          return `Parse error: ${e}\n` + am({ source: t, line: r, column: o }, 2)
        }
      }
    )
  }
  ...
  var ym = (function (e) {
      let t = '',
        ...
        i = Object.assign(
          new (class {
                ...
                this.offsetAndType = null,
                  ...
                  t(e, (e, t, c) => {
                    switch (e) {
                      ...
                      case a: {
                        let e = i & sd
                        for (i = o[e], a = i >> ad, o[s] = e, o[e++] = s; e < s; e++)
                          o[e] === n && (o[e] = s)
                        break
                      }
                      case 21:
            ...
            lookupOffset(e) {
              return (e += this.tokenIndex) < this.tokenCount
                ? this.offsetAndType[e - 1] & sd
                : this.source.length
            }
            lookupValue(e, t) {
              return (
                (e += this.tokenIndex) < this.tokenCount &&
                Ku(this.source, this.offsetAndType[e - 1] & sd, this.offsetAndType[e] & sd, t)
              )
            }
            getTokenStart(e) {
              return e === this.tokenIndex
                ...
                ? e < this.tokenCount
                  ? this.offsetAndType[e - 1] & sd
                  : this.offsetAndType[this.tokenCount] & sd
                : this.firstCharOffset
            }
            substrToCursor(e) {
            ...
            skipUntilBalanced(e, t) {
              ...
              e: for (; o < this.tokenCount && ((n = this.balance[o]), !(n < e)); o++)
                switch (
                  ((r = o > 0 ? this.offsetAndType[o - 1] & sd : this.firstCharOffset),
          ...
          })(e || {}),
          {
            ...
            eatIdent(e) {
              ;(1 !== this.tokenType || !1 === this.lookupValue(0, e)) &&
      ...
      return Object.assign(
        function (e, l) {
          ...
          if (!(c in i.context)) throw new Error('Unknown context `' + c + '`')
          'function' == typeof u &&
            i.forEachToken((e, n, r) => {
              if (25 === e) {
          ...
          return i.eof || i.error(), d
        },
        { SyntaxError: im, config: i.config }
      )
    })({
      ...
      return (
        e.children.forEach((e) => {
          switch (e.type) {
              ...
              switch (e.name.toLowerCase()) {
                ...
                case 'has':
                  if (e.children) {
                    ...
                    ;(t.a += n.a), (t.b += n.b), (t.c += n.c)
                  }
                  break
                case 'nth-child':
                case 'nth-last-child':
                  if (((t.b += 1), e.children.first.selector)) {
                ...
                case 'host':
                  if (((t.b += 1), e.children)) {
                    let n = { type: 'Selector', children: [] },
                      r = !1
                    e.children.first.children.forEach(
                      (e) =>
                        !r && ('Combinator' === e.type ? ((r = !0), !1) : void n.children.push(e))
                    )
                    let o = Om(n)[0]
                    ;(t.a += o.a), (t.b += o.b), (t.c += o.c)
                  }
                  break
                case 'after':
                case 'before':
            ...
            case 'PseudoElementSelector':
              switch (e.name) {
                ...
                case 'view-transition-new':
                  if (e.children && '*' === e.children.first.value) break
                  t.c += 1
                  break
                default:
                  t.c += 1
            ...
            case 'TypeSelector':
              let n = e.name
              n.includes('|') && (n = n.split('|')[1]), '*' !== n && (t.c += 1)
          }
        }),
        new Em(t, e)
      )
    ...
    Om = (e) => {
      ...
      let t = ((e) => {
        if ('string' == typeof e || e instanceof String)
          try {
            return ym(e, { context: 'selectorList' })
          } catch (t) {
            throw new TypeError(
        ...
        if (e instanceof Object) {
          if (e.type && ['Selector', 'SelectorList'].includes(e.type)) return e
          if (e.type && 'Raw' === e.type)
            try {
              return ym(e.value, { context: 'selectorList' })
            } catch (e) {
              throw new TypeError(
      ...
      if ('Selector' === t.type) return [Am(e)]
  ...
  const Lm = (e) => {
    ...
    _m = (e) => ({ selector: e.selectorText, styles: Nm(e.style) }),
    Dm = (e) => {
      const t = e.cssRules
      return R(t, (e) =>
        ((e) => e.type === window.CSSRule.IMPORT_RULE)(e)
          ? Dm(e.styleSheet)
          : ((e) => e.type === window.CSSRule.STYLE_RULE)(e)
          ? [_m(e)]
          : []
      )
    },
    Pm = (e, t) => {
      const n = N(t, (e, t) => ({ ...e, ...t.styles }), {})
  ...
  const Fm = { p: 'p, li[data-converted-paragraph]' },
    Um = (e, t) => {
      ...
      if (
        ...
        O(t, (t) => {
          ...
          ;((e) => {
            An(e, 'data-list-level'),
              ...
              Re($n(e), (t, n) => {
                !W(n, 'border') ||
                  ('border-image' !== n && 'none' !== t.trim() && 'initial' !== t.trim()) ||
                  Vn(e, n)
              })
          })(t),
            n.destroy(),
        ...
        O(n, (e) => {
          const t = Kt(e, 'li')
          Wn(e, 'margin-top').isNone() &&
            k.from(t[0]).each((t) => {
              Un(e, 'margin-top', zn(t, 'margin-top'))
            }),
            Wn(e, 'margin-bottom').isNone() &&
              k.from(t[t.length - 1]).each((t) => {
    ...
    Bm = (e, t, n) => {
      const r = (e) =>
        Tn(e, 'data-list-level')
          .map((e) => parseInt(e, 10))
          .getOr(1)
      return Wn(e, 'text-indent').bind((o) =>
        Wn(e, 'margin-left').map((s) => {
          ...
          const f = c - u - p
          return (m['margin-left'] = f > 0 ? f + 'px' : '0px'), m
        })
      )
    },
    zm = (e) => {
      const t =
        ((n = _e.fromDom(document.body)),
        {
          play: (e, t, r) => {
            const o = _e.fromTag('div'),
              s = _e.fromTag('iframe')
    ...
    Hm = (e, t, n, r) => {
      const o = e.html
      return n.cleanDocument(o, t, r).then(
        (e) => {
          if (null == (n = e) || 0 === n.length) return { response: jr([], []), bundle: Hr({}) }
          {
            const n = void 0 === r.sanitizer ? rc(r.intraFlag.isMarked) : r.sanitizer
            return ((e, t, n, r) => {
              const o = (e) => ({ response: e, bundle: Hr({}) }),
              ...
              return zm(e)(s).then((e) => {
                const t = qn(e),
                  ...
                  s = _e.fromTag('div')
                pn(s, t)
                const a = L(Tt('img[src]', s), (e) =>
                    Tn(e, 'src').exists((e) => W(e, 'blob:') || W(e, 'data:'))
                  ),
                  i = Tt('img[data-image-src]', s)
                if (0 === a.length && 0 === i.length) return r([])
                if (n)
                  return (
                    O(a, (e) => An(e, 'id')),
                    ((e) =>
        ...
        (e) => (
          ...
          { response: Mr('errors.paste.process.failure'), bundle: Hr({}) }
        )
      )
    },
    Wm = vt(),
    $m = (e) => {
      try {
        ...
        return (
          console.error('PowerPaste error code: PT01. Message: ', e),
          Tr.error('errors.paste.process.failure')
        )
      }
    },
    Vm = (e) => e.fold(Wr, (e) => ({ response: jr(e, []), bundle: Hr({}) })),
    Gm = (e, t, n, r, o) =>
      $m(() => {
        const s = {
          type: r,
          ...
          preprocessor: { defaultProtocol: o.defaultProtocol }
        }
        return ((e, t, n, r) => {
          Ki(n, r.preprocessor)
          const o = Kn(n),
                ...
                r = ((e, t) => {
                  const n = t.browser.isFirefox(),
                    r = So([
                      ...
                      To((e, t) => {
                        const n = ((e, t, n) =>
                          t(_e.fromDom(e.getNode())).fold(
                            () => [e],
                            (t) => {
                              const r = e.type() === ho,
                                o = [fo(t.dom, r)]
                              return !r && n && o.push(fo(t.dom, !0)), o
                            }
                          ))(t, s, a)
                        e.emitTokens(n)
                      }, d))
                    ...
                    o = n ? d : ia
                  var s, a
                  return { annotate: [e.type === bs.Word ? r : d], local: [o] }
                })(t, e)
              return P([
                r.local,
                Ua(t),
                za(t),
                r.annotate,
                ((o = n ? [] : t.cleanFilteredInlineElements), [Oa, La, ga(o)]),
                Ba(t),
                Wa(t, e),
                [Ms],
                [fa],
    ...
    Km = (e, t, n, r, o) =>
      Gm(e, t, r, n, o).fold($r, (e) => Promise.resolve({ response: jr(e, []), bundle: Hr({}) })),
    Jm = (e) => '\n' === e || '\r' === e,
    Ym = (e, t) => {
      const n = ((e) => {
          const t = _e.fromTag('div')
        ...
        r = ((e, t) => {
          const n = ((e, t) => {
              ...
              const o = N(
                n,
                (e, t) =>
                  ((e) => -1 !== ' \f\t\v'.indexOf(e))(t) || '\xa0' === t
                    ? e.pcIsSpace ||
                      '' === e.str ||
                      e.str.length === n.length - 1 ||
                      ((e, t) => t < e.length && t >= 0 && Jm(e[t]))(n, e.str.length + 1)
                      ? { pcIsSpace: !1, str: e.str + '\xa0' }
                      : { pcIsSpace: !0, str: e.str + ' ' }
                    : { pcIsSpace: Jm(t), str: e.str + t },
                { pcIsSpace: !1, str: '' }
              )
              return o.str
            })(e, t)
    ...
    Xm = (e) => (t, n) =>
      ((e, t) => {
        ...
        return { response: n.text.length > 0 ? Ym(n.text, t) : Fr(), bundle: Hr({}) }
      })(t, e),
    Zm = (e) => (t, n) => {
      const r = (t, r) => {
          const o = _e.fromTag('div')
          pn(o, t), Ki(o, e)
          const s = zt(o)
          return { response: jr(s, r), bundle: n.bundle }
        },
        o = m(n)
    ...
    ep = (e, t, n) => (r, o) => {
      ...
      return ((e) => ({
        handle: (t, n) =>
          e.proxyBin.fold(
            () => (console.error(t), Promise.resolve({ response: Fr(), bundle: Hr({}) })),
            n
          )
        ...
        return i
          ? ((e, t, n, r) => {
              ...
              return O(s, gn), Km(e, n, o, !0, r)
            })(l, t, r, n)
          : ((e, t, n, r, o) => Km(e, t, r, n, o))(l, r, o, a, n)
      })
    },
    tp = (e, t) => (n, r) => {
    ...
    rp = (e) => (t, n) => {
      ...
      return { response: n.response, bundle: r }
    },
    op = (e, t) =>
      ((e) => {
        const t = (e) => ({ response: jr([e], []), bundle: Hr({}) })
        return ((e) =>
          ((e) => {
            const t = Kt(e, 'img')
  ...
  var sp = (e, t, n, r) => (o, s) => {
    ...
    return new Promise((o, s) => {
      ...
      i.events.after.bind((e) => {
        ...
        t(n), Nn(n, fr())
        const s =
            (u = Kn(n)).indexOf('<o:p>') >= 0 ||
            u.indexOf('mso-list') >= 0 ||
            u.indexOf('p.MsoNormal, li.MsoNormal, div.MsoNormal') >= 0 ||
            u.indexOf('MsoListParagraphCxSpFirst') >= 0 ||
            u.indexOf('<w:WordDocument>') >= 0,
          i = ((e, t) => {
            const n = Kt(t, '*[id]')
        ...
        var u
        o({ response: a, bundle: Hr({ isWord: s, isGoogleDocs: i, isInternal: c, proxyBin: n }) })
      }),
        i.run()
    })
  }
  const ap = Lt([
    ...
    ip = { unsupported: ap.unsupported, supported: ap.supported, cata: (e, t, n) => e.fold(t, n) },
    lp = (e, t, n) => t.indexOf(e, n),
    cp = (e, t, n, r, o, s, a) =>
      -1 === e || -1 === t
        ? k.none()
        : k.some({ start: e, end: t, bower: n, regex: r, idRef: o, isEquation: s, attrs: a }),
    ...
    fp = (e) => {
      ...
      const n = () => e.length,
        r = (e) => {
          const n = ((e) => {
            ...
            return ((e) => {
              ...
              return ((e) =>
                e.indexOf('\\pngblip') >= 0
                  ? Tr.value('image/png')
                  : e.indexOf('\\jpegblip') >= 0
                  ? Tr.value('image/jpeg')
                  : Tr.error('errors.imageimport.unsupported'))(t).fold(
                (e) => ip.unsupported(a, e, r, o),
                (e) =>
                  ((e, t) => {
                    const n = e.match(t)
                    return n && n[1] && n[1].length % 2 == 0
                      ? Tr.value(n[1])
                      : Tr.error('errors.imageimport.invalid')
                  })(t, n).fold(
                    (e) => ip.unsupported(a, e, r, o),
                    (t) =>
                      ip.supported(
          ...
          return (t = t.concat(n.toArray())), e.end
        }
      let o = 0
      for (; o < e.length; ) o = pp(e, o).fold(n, r)
      return t
    },
    gp = (e) =>
      ip.cata(
    ...
    xp = (e, t, n, r, o) => {
      ...
      const l = R(e, (e, l) => {
        ...
        return (
          ...
          'unsupported' === c
            ? ((i = !0), wn(e, 'alt', n('errors.imageimport.unsupported')), [])
            : _(t, (e, t) => r(e, t, c, l)).fold(
                () => (
                  console.log('WARNING: unable to find data for image ', e.dom),
                  (i = !0),
      ...
      return { blobs: l, filteredImages: s, imageAttrs: a, failedImage: i }
    },
    kp = (e, t, n, r, o) => {
      const s = ((e) =>
          N(
            ...
            (e, t) => {
              const n = gp(t),
                r = vp(t)
              return D(e, (e) => !(r || vp(e)) && gp(e) === n).fold(
                () => e.concat([t]),
                (n) =>
                  yp(e[n]).isValue()
                    ? e
                    ...
                    t.fold(
                      ...
                      (t) =>
                        Nc.cata(
                          ...
                          (n, r, o) =>
                            r.toCanvas().then((s) => {
                              ...
                              return i === c.cropw &&
                                ...
                                0 === c.cropt
                                ? Promise.resolve(e)
                                : ui(r, c.cropl, c.cropt, c.cropw, c.croph).then((e) =>
                                    e.toBlob().then((t) => {
                          ...
                          (t, n, r) => Promise.resolve(e)
                        )
                    ))(e, t[n])
                )
              )
            : Promise.resolve(e))(e, m).then((e) => {
          const t = jc(e, h)
          n(t, f)
        })
      })
            ...
            (t, o) => {
              ...
              o
                ? (console.error('PowerPaste error code: RTF01'),
                  n.trigger.incomplete(s, a, 'errors.imageimport.failed'))
                : n.trigger.insert(s, a)
            },
            t,
            s
          )
  ...
  const Cp = (e) => {
    ...
    return Nc.cata(
      e.asset,
      (n, r, o) =>
        /(tiff|pdf)$/.test(r.getType())
          ? ((e) =>
              ((e, t, n) => e.toAdjustedBlob(t, n))(e, 'image/png')
                .then(_c)
                .then(k.some)
                .catch((e) => (console.warn(e), k.none())))(r).then((t) =>
              t
                .map((t) => {
                  const n = e.image
                  return URL.revokeObjectURL(o), Mc(t, n), Rc(t, n)
                })
                .getOr(e)
            )
          : t(),
  ...
  var Tp = (e, t) => {
    const n = (e, n) => Promise.all(A(e, Cp)).then((e) => ({ response: n(e), bundle: t.bundle }))
    return Rr(
      t.response,
      $r,
      (e, t) => n(t, (t) => jr(e, t)),
      () => Promise.resolve(t),
      (e, t, r) => n(t, (t) => (console.error('PowerPaste error code:  IMG01'), Ur(e, t, r)))
    )
  }
  const Ip = (e, t) => (e.isSupported ? t.getWordData() : k.none()),
    ...
    Dp = (e) => e.getVoid(),
    Pp = (e, t, n, r) => ({ label: e, getAvailable: t, steps: n, capture: m(r) }),
    Rp = (e, t, n, r) => ({ label: e, getAvailable: t, steps: n, capture: m(r) }),
    Mp = (e, t, n, r) => {
      return Pp(
        Ac.native,
        Ep,
        [
          ...
          (e, t) => {
            ...
            const s = r.isSome()
            return { response: t.response, bundle: Hr({ isInternal: s }) }
          }),
          du(e, t),
          Qm(n, r, t),
          Vc(t),
        ...
        [
          ...
          (e, t) =>
            new Promise((n, o) => {
              ...
              ;((e, t) => {
                const n = De(t)
                if (n.length !== Yi.length) throw new Error('Partial match')
                U(n, (n) => Rn(e.discriminator === n, t[n])).getOrDie(
                  'Must find branch for constructor: ' + e.discriminator
                )(e.data)
              })(i.rtf, {
                disabled: () => {
                  l(k.none())
    ...
    Fp = (e, t, n, r) =>
      Pp(
        Ac.googledocs,
        _p,
        [rp({ isGoogleDocs: !0 }), uu(e, t), op, Qm(n, r, t), ru, Vc(t), Tp],
        !0
      ),
    Up = (e) =>
      Pp(
        ...
        [
          !1 === e.allowLocalImages
            ? (e, t) => $r('errors.local.images.disallowed')
            : (e, t) =>
                ((e) => {
                  ...
                  return Pc(n).then((e) => {
                        ...
                        O(e, (e) =>
                          Nc.cata(
                            ...
                            (r, o, s) => {
                              ...
                              wn(a, 'src', s), t.push(a), n.push(Rc(e, a))
                            },
                            (e, t, n) => {
                              console.error(
                    ...
                    return { response: t, bundle: Hr({}) }
                  })
                })(pc(e).getOrDie('Must have image data for images handler').images),
          Tp
        ],
        !0
      ),
    Bp = (e) =>
      Pp(Ac.plaintext, Np, [Xm(e.tabSpaces), Zm({ defaultProtocol: e.defaultProtocol })], !0),
    zp = (e, t) => Pp(Ac.text, Lp, [Xm(e), Zm({ defaultProtocol: t })], !0)
  var Hp = Object.freeze({ __proto__: null, loadScript: (e, t) => tinymce.Resource.load(e, t) })
  const Wp = {
    ...
    Xp = (e) => {
      ...
      return k.from(t).bind((t) => {
        const n = { url: t[1], html: e }
        return Rn(t[1] === t[2], n)
      })
    },
    Zp = (e, t, n) =>
      ((e) => 'extra' in e.undoManager)(e)
        ? (e.undoManager.extra(() => {
            tf(e, t)
          }, n),
          k.some(!0))
    ...
    Qp = (e, t) =>
      Xp(t).bind((t) =>
        !1 === e.selection.isCollapsed() && Yp(t.url)
          ? ((e, t) =>
              Zp(e, t.html, () => {
    ...
    tf = (e, t) => (e.insertContent(t, { merge: Q(e), paste: !0 }), k.some(!0)),
    nf = (e, t) => e.hasEventListeners(t),
    rf = (e, t, n, r, o) => {
      const s = ((e) => e.replace(Kp, ''))(t),
        a = ((e, t, n, r, o) =>
          nf(e, 'PastePreProcess')
            ? ((e, t, n, r, o) => {
                ...
                return a ? { cancelled: a } : { cancelled: a, content: s.content }
              })(e, t, n, r, o)
            : { cancelled: !1, content: t })(e, s, n, r, o)
      return a.cancelled
        ? a
        : ((e, t, n, r, o) =>
            nf(e, 'PastePostProcess')
              ? ((e, t, n, r, o) => {
                  const s = e.dom.add(e.getBody(), 'div', { style: 'display:none' }, t),
                  ...
                  if (i) return { cancelled: i }
                  const l = a.node.innerHTML
                  return e.dom.remove(s), { cancelled: i, content: l }
                })(e, t, n, r, o)
              : { content: t, cancelled: !1 })(e, a.content, n, r, o)
    },
    of = (e, t, n, r, o, s) => {
      const a = fe(),
        i = ('/js', (r ? r.jsUrl : n).replace(/\/$/, '') + '/' + '/js'.replace(/^\//, ''))
      const c = (e, t) => (
          e.undoManager.transact(() => {
            ...
            tf(e, t),
              ...
              O(A(n.getElementsByTagName('*'), _e.fromDom), (e) => {
                In(e, 'data-mce-style') &&
                  !In(e, 'style') &&
                  Tn(e, 'data-mce-style').each((t) => wn(e, 'style', t))
              })
          }),
          k.some(!0)
        ),
        u = () => {
          a.on((t) => e.selection.moveToBookmark(t)), a.clear()
        },
        h = ee(e),
        m = {
          baseUrl: i,
          ...
          pasteBinAttrs: { 'data-mce-bogus': 'all', class: 'mce-pastebin' },
          intraFlag: {
            isMarked: Jp,
            findClipboardTags: (e) => {
        ...
        p = ((e, t, n, r, o = Dr) => {
          const s = { ...{ ...pr, sanitizer: rc(r.intraFlag.isMarked) }, ...Fe(r, l) },
            ...
            c = [
              ...
              Mp(t, s, n, e),
              Up(s),
              zp(s.tabSpaces, s.defaultProtocol)
            ],
            u = ((e, t, n, r, o) =>
              Rp(
                Ac.fallback,
                Ap,
                [sp(r, n, o, t.intraFlag), du(e, t), ep(o, t.intraFlag, t), Vc(t), Tp],
                !1
              ))(t, s, n, i, e)
          return Ec(c, u, s.sanitizer)
        })(
          _e.fromDom(e.getBody()),
          ((e) => ({
            createDialog: () => {
              let t = ''
              const n = fe(),
                r = (() => {
                  const e = pe([{ text: 'Close', name: 'close', type: 'custom', primary: !0 }]),
                    t = pe({})
                  return {
                    setButtons: (n) => {
                      const r = {},
                        o = A(n, (e) => {
                          const t = e.text
                          return (
                            (r[t.toLowerCase()] = e.click),
                            { text: t, name: t.toLowerCase(), type: 'custom' }
                          )
                        })
                      t.set(r), e.set(o)
                    },
                ...
                show: () => {
                  n.on((n) => {
                    const o = Vp(n.dom),
                      a = {
                        title: t,
                        body: { type: 'panel', items: [{ type: 'htmlpanel', html: o }] },
                        initialData: {},
                        buttons: r.getButtons(),
                        onCancel: s,
                        onAction: (e, t) => {
                          r.getAction(t.name).each(y), e.close()
                        }
                      }
        ...
        f = ((e = oc, t = pr.tabSpaces) =>
          Ec([zp(t, pr.defaultProtocol)], Rp(Ac.discard, Dp, [np], !0), e))(o, h)
      return (
        O([p, f], (t) => {
            ...
            t.events.error.bind((t) => {
              u(),
                e.notificationManager
                  ? e.notificationManager.open({ text: $p(t.message), type: 'error' })
                  : ((e, t) => {
                      const n = {
                        title: 'Error',
                        body: { type: 'panel', items: [{ type: 'htmlpanel', html: t }] },
                        initialData: {},
        ...
        }),
        {
          ...
          pasteText: (e) =>
            f.pasteCustom(
              ((e, t = oc) => ({
                ...
                getImage: k.none,
                getHtml: k.none,
                getText: () => k.some(dc({ text: t.sanitizeText(e) })),
                getNative: v('There is no native event'),
                getOnlyText: k.none,
                getVoid: v('There is no paste event')
              }))(e, o)
          ...
          pasteEvent: (n) => {
            ;((e) => {
              return ((t = e),
              k.from(t.clipboardData).bind((e) => k.from(e.getData('text/html')))).bind((e) =>
                ((e) => H(e, '<google-sheets-html-origin'))(e)
                  ? k.some('googlesheets')
                  : ((e) =>
                      H(e, ' data-ccp-props=') &&
                      H(e, ' paraid=') &&
                      /font-family:.+?_MSFontService(&quot;)?[,;]/.test(e))(e)
                  ? k.some('mswordonline')
                  : ((e) =>
                      H(e, '<meta name=ProgId content=Excel.Sheet>') &&
                      !H(e, '="urn:schemas-microsoft-com:office:'))(e)
                  ? k.some('msexcelonline')
                  : k.none()
              )
              var t
            })(n).each((t) => {
              ;((e, t) => {
                e.dispatch('PowerPasteTempStats', { source: t })
              })(e, t)
            }),
    ...
    sf = (e, t) => {
      const n = tinymce.html
        .DomParser({}, e.schema)
        .parse(t, { forced_root_block: !1, isRootContent: !0 })
    ...
    lf = (e) => {
      var t, n
      return I(
        null !== (n = null === (t = e.dataTransfer) || void 0 === t ? void 0 : t.items) &&
          void 0 !== n
          ? n
          : [],
        (e) => W(e.type, 'image/')
    ...
    cf = (e, t, n, r) => {
      ...
      const a = (t) => {
        var n, r
        const s = o.getCaretRangeFromPoint(
          null !== (n = t.clientX) && void 0 !== n ? n : 0,
          null !== (r = t.clientY) && void 0 !== r ? r : 0,
          e.getDoc()
        )
        e.focus(), l(s) && e.selection.setRng(s)
      }
      e.on('dragstart dragend', (e) => {
        s = 'dragstart' === e.type
      }),
        e.on('dragover dragend dragleave', (e) => {
          s || lf(e) || (e.preventDefault(), a(e))
        })
      ...
      e.on('drop', (t) => {
        if (!s && !lf(t)) {
                ...
                null !==
                  (o =
                    null !== (n = t.target.files) && void 0 !== n
                      ? n
                      : null === (r = t.dataTransfer) || void 0 === r
                      ? void 0
                      : r.files) && void 0 !== o
                  ? o
                  : [],
                ...
                Pc(t).then((t) => {
                  const n = ((e) =>
                      A(e, (e) => {
                        ...
                        return wn(t, 'src', n), t.dom.outerHTML
                      }).join(''))(t),
                    o = rf(e, n, !1, 'imagedrop', 'auto')
                  o.cancelled ||
                    (e.insertContent(o.content, { merge: Q(e) }), re(e) && r.uploadImages(t))
                })
              })(o),
          ...
          i(s, 'text/html')
            ? (n.pasteHtml(s['text/html']), t.preventDefault())
            : i(s, 'text/plain') &&
              !((e) => {
                const t = e['text/plain']
                return !!t && 0 === t.indexOf('file://')
              })(s) &&
              (n.pasteText(s['text/plain']), t.preventDefault())
        }
      })
    }
      ...
      ((e) => (t, r) => {
        if (
            ...
            -1 ===
              ((e, t) => {
                ...
                ((e) =>
                  Y(
                    ((e) =>
                      [e.majorVersion, e.minorVersion].join('.').split('.').slice(0, 3).join('.'))(
                      e
                    )
                  ))(e),
                Y(t)
          ...
          return void console.error(
            'The "powerpaste" plugin requires at least version 6.0.0 of TinyMCE.'
          )
        ;((e) => {
          const t = e.options.register,
            r = (e) => {
              ...
              return t
                ? { value: e, valid: t }
                : { valid: !1, message: 'Must be prompt, clean or merge.' }
            }
          t('powerpaste_block_drop', { processor: 'boolean', default: !1 }),
            t('powerpaste_keep_unsupported_src', { processor: 'boolean', default: !1 }),
            t('powerpaste_allow_local_images', { processor: 'boolean', default: !0 }),
            t('powerpaste_word_import', { processor: r, default: 'prompt' }),
            t('powerpaste_googledocs_import', { processor: r, default: 'prompt' }),
            t('powerpaste_html_import', { processor: r, default: 'clean' }),
            t('powerpaste_clean_filtered_inline_elements', { processor: 'string[]', default: [] }),
            e.options.isRegistered('link_default_protocol') ||
              t('link_default_protocol', { processor: 'string', default: 'https' })
        })(t),
          ((e) => {
            const t = e.options.set
            t('paste_block_drop', !1), t('paste_remove_styles_if_webkit', !1)
          })(t)
        const o = ((e) => {
            const t = pe(Z(e)),
              n = pe(!1)
            return (
              e.on('keydown', (e) => {
                ;((e) => tinymce.util.VK.metaKeyPressed(e) && 86 === e.keyCode && e.shiftKey)(e) &&
                  n.set(!0)
              }),
          ...
          a = ((e) => {
            const t = rc(Jp),
              n = ((e) => ({ sanitizeHtml: g(sf, e), sanitizeText: p }))(e)
            return {
        ...
        t.on('PreInit', () => {
          ...
          ;((e, t) => {
            ...
            se(t)
              ? ((e) => {
                  af(e, e.getBody()), e.inline || af(e, e.getDoc())
                })(t)
              : cf(t, 0, i, s)
        })
      })(undefined)
