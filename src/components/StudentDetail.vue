    ...
    <a-form ref="formRef" :model="masterData" name="basic">
      <a-row :gutter="[16, 24]">
        <a-col :span="12"
          ><a-form-item
            label="Mã học viên"
            name="Code"
            :rules="[{ required: true, message: 'Mã học viên không được để trống!' }]"
          >
      ...
      <a-row :gutter="[16, 24]">
        <a-col :span="12">
          <a-form-item
            label="Tên học viên"
            name="FullName"
            :rules="[{ required: true, message: 'Tên học viên không được để trống!' }]"
          >
            <a-input v-model:value="masterData.FullName" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
      ...
      <a-row :gutter="[16, 24]">
        <a-col :span="12"
          ...
          >
            <a-input v-model:value="masterData.Mobile" /> </a-form-item
        ></a-col>
        <a-col :span="12">
...
<script lang="ts" src="./StudentDetail.ts" />
